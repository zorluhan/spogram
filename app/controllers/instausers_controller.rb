class InstausersController < ApplicationController
  ...
  def callback 
    ...
    if client.user.username == "zorluhan2" or client.user.username == "meikaash" or client.user.username == "zorluhan2017" or client.user.username == "sahikasss" or client.user.username == "melihsahinkaya" or client.user.username == "opprette" or client.user.username == "tanemsivar" or  client.user.username == "vlad.bomboe"
